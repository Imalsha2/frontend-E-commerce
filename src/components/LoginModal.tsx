        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors"
                onClick={() => alert('Apple Sign In would be integrated here')}
              >
